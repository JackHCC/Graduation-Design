...
plt.title(str(sec2time(test_sec)) + "密度分布真实图", fontsize='7')
...
for Link_Num in range(2, 10):
    ...
    plt.title(str(sec2time(test_sec)) + "密度分布预测图，预测窗口长：" + str(Link_Num), fontsize='7')
...
# 图片存储在HotSpotPlot目录
plt_name = './PredictHotSpotSVR/HotSpot_Real_Predict_'+str(test_sec)+'_2-9_update'
